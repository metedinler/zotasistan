...
STORAGE_DIR = os.getenv('STORAGE_DIR')      # PDF dosyalarının bulunduğu dizin (ör. C:\Users\mete\Zotero\storage)
SUCCESS_DIR = os.getenv('SUCCESS_DIR')      # Çıktıların saklanacağı dizin (ör. C:\Users\mete\Zotero\zotasistan)
